...
A mini-course for React developers to learn Vim commands and apply them to
real-world scenarios by fixing and editing React code. You'll go through a
series of tasks, each with broken or missing code, that you will fix using
specific Vim motions.

FIELDNOTES LAB COMPANION

This file is the deliberate-practice lab for the Neovim track linked from the
workspace home page. Complete lessons 1–3 before starting it, then return here
for spaced practice after lessons 4 and 8. The goal is not to finish quickly:
before each edit, say the command as an operator plus a target; after each edit,
inspect the result and undo it once so recovery becomes automatic.
...
If you still occasionally use your arrow keys or mouse, that's okay — don't put
...
Cheat sheet: https://github.com/leerob/vim-for-react-devs (original source)
